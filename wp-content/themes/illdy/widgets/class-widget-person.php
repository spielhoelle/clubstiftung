...
class Illdy_Widget_Person extends WP_Widget {
        ...
        $output .= '<div class="fader person clearfix" data-person-color="'. $color .'">';
            ...
            $output .= '<div class="person-content">';
                ...
                $output .= '<ul class="person-content-social clearfix">';
                    ...
                    $output .= ( $mail_url ) ? '<li><a href="mailto:'. $mail_url .'" title="'. __( 'mail', 'illdy' ) .'"><i class="fa fa-envelope" target="_blank" rel="nofollow"></i><span>'.$mail_url.'</span></a></li>' : '';
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'phone_url' ); ?>"><?php _e( 'phone', 'illdy' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'mail_url' ); ?>"><?php _e( 'mail', 'illdy' ); ?></label>
