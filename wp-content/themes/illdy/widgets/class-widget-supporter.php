<?php
class Illdy_Widget_Support extends WP_Widget {

    /**
     * Register widget with WordPress.
     */
    function __construct() {
        parent::__construct( 'illdy_support', __( '[Illdy] - Support', 'illdy' ), array( 'description' => __( 'Add this widget in "Front page - Supports Sidebar".', 'illdy' ), ) );
    ...
    public function widget( $args, $instance ) {
        ...
        $get_attachment_image_src = wp_get_attachment_image_src( $image_id, 'illdy-front-page-supports', 'full' );
    ...
    public function form( $instance ) {
        $title = !empty( $instance['title'] ) ? sanitize_text_field( $instance['title'] ) : __( '[Illdy] - Support', 'illdy' );
        $image = !empty( $instance['image'] ) ? esc_url( $instance['image'] ) : '';
        $url = !empty( $instance['url'] ) ? sanitize_text_field( $instance['url'] ) : esc_url( '#' );
        ?>
        <p>
...
function illdy_register_widget_support () {
    register_widget( 'Illdy_Widget_Support' );
}
add_action( 'widgets_init', 'illdy_register_widget_support' );
