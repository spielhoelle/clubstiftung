...
class Illdy_Widget_Project extends WP_Widget {
    ...
    public function form( $instance ) {
        ...
        $image = !empty( $instance['image'] ) ? esc_url( $instance['image'] ) : '';
        $url = !empty( $instance['url'] ) ? sanitize_text_field( $instance['url'] ) : esc_url( '#' );
        $content = !empty( $instance['content'] ) ? sanitize_text_field( $instance['content'] ) : __( 'Description', 'illdy' );
        ?>
        <p>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'content' ); ?>"><?php _e( 'Content:', 'illdy' ); ?></label>
