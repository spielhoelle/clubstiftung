...
// Show this section
	...
	// Type of Background
	wp.customize( 'illdy_services_background_type', function( value ) {
		value.bind( function( newval ) {
			if( newval == 'image' ) {
				$( '#services' ).css( 'background-color', '' );
				$( '#services' ).css( 'background-image', 'url('+ wp.customize._value.illdy_services_background_image() +')' );
			} else if( newval == 'color' ) {
				$( '#services' ).css( 'background-image', '' );
				$( '#services' ).css( 'background-color', 'color:' + wp.customize._value.illdy_services_background_color() );
			}
		} );
	} );

	// Image
	wp.customize( 'illdy_services_background_image', function( value ) {
		value.bind( function( newval ) {
			if( newval == '' ) {
	...
	// Color
	wp.customize( 'illdy_services_background_color', function( value ) {
		value.bind( function( newval ) {
