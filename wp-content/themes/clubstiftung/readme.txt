...
A starter theme called clubstiftung.

== Description ==

clubstiftung is a free premium one page WordPress theme.
...
### v1.0.4
	- Has been renamed "clubstiftung_get_cf7_forms()" function instead "pixova_lite_get_cf7_forms()".
...
= License =
clubstiftung WordPress theme, Copyright (C) 2015 Colorlib.com
clubstiftung WordPress theme is licensed under the GPL3.
