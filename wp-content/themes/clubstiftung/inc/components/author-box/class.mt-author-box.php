...
if( !function_exists( 'clubstiftung_CallAuthorBoxClass' ) ) {
    /**
     *
     ...
     *
     */
    function clubstiftung_CallAuthorBoxClass()
    {
        $display_author_box = get_theme_mod( 'clubstiftung_enable_author_box_blog_posts', 1 );

        if ( $display_author_box == 1 ) {
            // instantiate the class & load everything else
            clubstiftung_Author_Box_Output::getInstance();
        }
    }
    add_action('wp_loaded', 'clubstiftung_CallAuthorBoxClass');
}

if( !class_exists( 'clubstiftung_Author_Box_Output' ) ) {

    /**
     * Class clubstiftung_Author_Box_Output
     */
    class clubstiftung_Author_Box_Output {
        ...
        protected function __construct() {
            add_action( 'clubstiftung_single_after_content', array( $this, 'output_author_box' ), 3 );
        }
