 ...
 */
if( !class_exists( 'clubstiftung_CF7_Custom_Control' ) ) {
    class clubstiftung_CF7_Custom_Control extends WP_Customize_Control {
        /**
        ...
        * @return bool
        ...
        public function clubstiftung_get_cf7_forms() {
            global $wpdb;
            ...
            if ( $this->active_callback()) {
                ...
                if ($cf7) {
                    ...
                    $contact_forms[0] = __('No contact forms found', 'clubstiftung');
                }
            }
        ...
        public function render_content() {
            $Pixova_Lite_contact_forms = $this->clubstiftung_get_cf7_forms();

            if ( !empty($Pixova_Lite_contact_forms ) ) { ?>
                <span class="customize-control-title"><?php echo esc_html($this->label); ?></span>
                <select <?php esc_url($this->link()); ?> style="width:100%;">
                <?php echo '<option value="default">'.__('Select your contact form', 'clubstiftung').'</option>';
 ...
 *  Custom Control: Text
 */
if( !class_exists( 'clubstiftung_Text_Custom_Control' ) ) {
    class clubstiftung_Text_Custom_Control extends WP_Customize_Control {
        public function render_content() {
            $output = '';
