<?php
class clubstiftung_Widget_Skill extends WP_Widget {

    /**
    * Register widget with WordPress.
    */
    function __construct() {
        parent::__construct( 'clubstiftung_skill', __( '[clubstiftung] - Skill', 'clubstiftung' ), array( 'description' => __( 'Add this widget in "Front page - About Sidebar".', 'clubstiftung' ), ) );
    ...
    */
    public function form( $instance ) {
        $title = ! empty( $instance['title'] ) ? sanitize_text_field( $instance['title'] ) : __( '[clubstiftung] - Skill', 'clubstiftung' );
        $percentage = !empty( $instance['percentage'] ) ? absint( $instance['percentage'] ) : '';
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'percentage' ); ?>"><?php _e( 'Percentage:', 'clubstiftung' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'icon' ); ?>"><?php _e( 'Icon:', 'clubstiftung' ); ?></label>
            <select class="widefat" id="<?php echo $this->get_field_id( 'icon' ); ?>" name="<?php echo $this->get_field_name( 'icon' ); ?>">
                <option value="all-font-awesome-icons"><?php _e( 'All Font Awesome Icons', 'clubstiftung' ); ?></option>
...
add_action( 'widgets_init', 'clubstiftung_register_widget_skill' );
function clubstiftung_register_widget_skill () {
    register_widget( 'clubstiftung_Widget_Skill' );
}