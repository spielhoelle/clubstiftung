<?php
class clubstiftung_Widget_Service extends WP_Widget {

    /**
    * Register widget with WordPress.
    */
    function __construct() {
        parent::__construct( 'clubstiftung_service', __( '[clubstiftung] - Service', 'clubstiftung' ), array( 'description' => __( 'Add this widget in "Front page - Services Sidebar".', 'clubstiftung' ), ) );
    }
    ...
    */
    public function form( $instance ) {
        $title = ! empty( $instance['title'] ) ? sanitize_text_field( $instance['title'] ) : __( '[clubstiftung] - Service', 'clubstiftung' );
...
add_action( 'widgets_init', 'clubstiftung_register_widget_service' );
function clubstiftung_register_widget_service () {
    register_widget( 'clubstiftung_Widget_Service' );
}
